...
self.__precacheManifest = [
  {
    "url": "webpack-runtime-bca747010ab219b17502.js"
  },
  {
    "url": "app-ccdf26dd63cd88231488.js"
  },
  {
  ...
  },
  {
    ...
    "revision": "2c20b8e047108018b2dd5a2c8ecddd4e"
  },
  {
  ...
  {
    "url": "manifest.json",
    "revision": "a293be1edaab2604b15a116e1517dae7"
  },
  {
...
var navigationRoute = new workbox.routing.NavigationRoute(function (_ref) {
  ...
  return idbKeyval.get(WHITELIST_KEY).then(function (customWhitelist) {
    ...
    if (customWhitelist.includes(pathname)) {
      var offlineShell = "/mcmillar-portfolio/offline-plugin-app-shell-fallback/index.html";
...
var messageApi = {
  whitelistPathnames: function whitelistPathnames(event) {
    ...
    pathnames = pathnames.map(function (_ref3) {
      ...
      if (!includesPrefix) {
        return "/mcmillar-portfolio" + pathname;
      } else {
        return pathname;
      }
    });
